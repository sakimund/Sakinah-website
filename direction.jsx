...
function DirZacka({ darkMode, accent }) {
  ...
  const z = {
    ...
    nav: {
      display: 'flex', justifyContent: 'center', gap: '36px', alignItems: 'baseline',
      fontFamily: '"Source Serif 4", Georgia, serif',
    ...
    name: {
      fontSize: '56px', fontWeight: 700, margin: '-8px 0 24px',
    ...
    grid: {
      display: 'grid', gridTemplateColumns: '320px 1fr', gap: '56px',
      alignItems: 'start'
    },
    photoWrap: {
    ...
    pageH1: {
      fontSize: '40px', fontWeight: 700, margin: '0 0 32px 0',
      marginLeft: '-2px',
            ...
            <div style={{
              ...
              <div>
                ...
                <img
                  ...
                  style={{ width: '100%', display: 'block', marginTop: '64px', background: c.photoBg }}
                />
              </div>
              <div>
                <img
                  ...
                  style={{ width: '100%', display: 'block', marginTop: '24px', background: c.photoBg }}
                />
              </div>
            </div>
          </div>
